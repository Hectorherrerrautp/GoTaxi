...
class GetPlaceCommand extends smithy_client_1.Command
    ...
    .f(models_0_1.GetPlaceRequestFilterSensitiveLog, models_0_1.GetPlaceResponseFilterSensitiveLog)
    .ser(Aws_restJson1_1.se_GetPlaceCommand)
    .de(Aws_restJson1_1.de_GetPlaceCommand)
    .build() {
}
